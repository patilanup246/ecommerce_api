# Generated by Django 2.2 on 2020-08-02 11:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('dashboard', '0024_auto_20200802_1645'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='order_id',
            field=models.CharField(blank=True, default='coose', max_length=100, unique=True),
        ),
        migrations.AlterField(
            model_name='product',
            name='product_id',
            field=models.CharField(blank=True, default='nzchs', max_length=100, unique=True),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_type_id', models.IntegerField(blank=True, null=True)),
                ...
                ('create_user', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_by_dashboard_vendor_management_related', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('write_user', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='written_by_dashboard_vendor_management_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
